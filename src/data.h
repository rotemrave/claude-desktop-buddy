...
m5::rtc_time_t tm = { (int8_t)lt.tm_sec, (int8_t)lt.tm_min, (int8_t)lt.tm_hour };
m5::rtc_date_t dt = { (int16_t)(lt.tm_year + 1900), (int8_t)(lt.tm_mon + 1), (int8_t)lt.tm_mday, (int8_t)lt.tm_wday };
